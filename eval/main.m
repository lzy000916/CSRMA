...
ResultMapPath = '../Result/';
Models = {'CSRMAUNet_Kvasir_1e4_bs8_e120_s352_25'}; %{'UNet','UNet++','PraNet','SFA'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----   
DataPath = '../data/TestDataset/';
Datasets = {'ETIS-LaribPolypDB'}; %{'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'};
% ---- 3. Evaluation Results Save Path Setting ----
ResDir = './EvaluateResults/CSRMAUNet_Kvasir_1e4_bs8_e120_s352_25/';
