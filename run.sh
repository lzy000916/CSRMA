...
if [ -f "$dir/Train.py" ];then
    ...
    #python Train.py --model_name CSCAUNet --epoch 120 --batchsize 8 --trainsize 352 --train_save CSCAUNet_Kvasir_1e4_bs8_e120_s352_25 --lr 0.0001 --train_path $dir/data/TrainDataset --test_path $dir/data/TestDataset/Kvasir/
    #sleep 1m
    python Test.py --train_save CSCAUNet_Kvasir_1e4_bs8_e120_s352_25 --testsize 352 --test_path $dir/data/TestDataset
