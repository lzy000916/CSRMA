...
class CSRMAUNet(nn.Module):
    def __init__(self, n_class=1, decay=2):
        super(CSRMAUNet, self).__init__()
        ...
        self.up_conv5 = CSRMA_blocks(1024, 512, decay)
        self.up_conv4 = CSRMA_blocks(512, 256, decay)
        self.up_conv3 = CSRMA_blocks(256, 128, decay)
        self.up_conv2 = CSRMA_blocks(128, 64, decay)
        self.up_conv1 = CSRMA_blocks(64, 32, decay)
